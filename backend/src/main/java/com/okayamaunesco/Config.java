...
public class Config {
    public static final String DB_URL =
        getenv("DB_URL", "jdbc:mysql://localhost:3306/okayama_unesco"
            + "?useSSL=false&serverTimezone=Asia/Tokyo&characterEncoding=utf8");
    ...
    public static final String CORS_ORIGIN = getenv("CORS_ORIGIN", "*");
